...
function compute_parameters(train_data, train_data_plot, ps_posttraining; coarse_size=32, dev=cpu_device(), solver=DP5(), Ri_clamp_lims=(-Inf, Inf))
...
sols, fluxes, diffusivities = compute_parameters(train_data, train_data_plot, ps, Ri_clamp_lims=(-20, 20), solver=VCABM3())
