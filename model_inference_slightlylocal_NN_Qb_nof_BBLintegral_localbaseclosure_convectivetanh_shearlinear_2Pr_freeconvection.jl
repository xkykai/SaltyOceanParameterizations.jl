...
FILE_DIR = "./training_output/NDE_FC_Qb_nof_BBLintegral_trainFC24new_scalingtrain54new_2layer_64_relu_2Pr"
@info FILE_DIR
...
#%%
jldopen("$(FILE_DIR)/model_inference_run_nof_BBLintegral.jld2", "w") do file
