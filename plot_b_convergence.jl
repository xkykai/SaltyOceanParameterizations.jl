...
with_theme(theme_latexfonts()) do
    ...
    axAMD = Axis(fig[1, 1], xlabel="Buoyancy (m s⁻²)", ylabel="z (m)", title="Centered 2nd Order + AMD")
    ...
    save("./Data/b_quarterdomain_convergence_AMD_WENO9nu0.png", fig, px_per_unit=8)
end
#%%