...
FILE_NAME = "linearTS_b_dTdz_$(dTdz)_dSdz_$(dSdz)_QU_$(Qᵁ)_QB_$(Qᴮ)_T_$(T_surface)_S_$(S_surface)_f_$(f)_$(args["advection"])_Lxz_$(Lx)_$(Lz)_Nxz_$(Nx)_$(Nz)"
...
time_str = @lift "Qᵁ = $(Qᵁ), Qᴮ = $(Qᴮ), f = $(f), (SI units), Time = $(round(bbar_data.times[$n]/24/60^2, digits=3)) days"
