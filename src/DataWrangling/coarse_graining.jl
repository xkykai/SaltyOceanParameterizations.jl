...
Downsample a `Face`-centered field `Φ` down to size `n`. `Φ` is required to have evenly spaced points. The values at the left and right endpoints of `Φ` will be preserved in the output.
"""
# TODO: Figure out how to correctly coarse grain face centered fields to conserve flux
