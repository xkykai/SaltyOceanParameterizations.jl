...
FILE_DIR = "./training_output/1CNN_3conv_stride5_128_swish_local_diffusivity_clamp_-20_20_fast_VCABM3_ADAM1e-4_rho0.3_test"
mkpath(FILE_DIR)
@info "$(FILE_DIR)"
...
NN = Chain(Conv(Tuple(5), 10 => 8, swish),
           Conv(Tuple(5), 8 => 8, swish),
           Conv(Tuple(5), 8 => 8, swish),
           FlattenLayer(),
        #    Dense(28*8, 124)
           Dense(20*8, 128, swish),
           Dense(128, 124)
)
        #    FlattenLayer(),
        #    Dense(6*16, 128, swish),
