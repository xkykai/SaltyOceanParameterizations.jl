...
FILE_DIR = "./training_output/1CNN_maxpool_128_swish_local_diffusivity_clamp_-20_20_fast_VCABM3_ADAM1e-4_rho0.3_test"
mkpath(FILE_DIR)
@info "$(FILE_DIR)"
...
NN = Chain(Conv(Tuple(3), 10 => 16, swish),
           MaxPool(Tuple(2), stride=2),
           Conv(Tuple(3), 16 => 32, swish),
           MaxPool(Tuple(2), stride=2),
           FlattenLayer(),
           Dense(32*6, 128, swish),
           Dense(128, 124)
)
