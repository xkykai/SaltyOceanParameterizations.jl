...
FILE_DIR = "./training_output/1CNN_maxpool_stride5_128_swish_local_diffusivity_piecewise_linear_nodensity_noclamp_VCABM3_reltol1e-5_ADAM1e-3_lossequal_test"
mkpath(FILE_DIR)
@info "$(FILE_DIR)"
