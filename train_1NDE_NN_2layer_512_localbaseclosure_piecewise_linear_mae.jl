...
FILE_DIR = "./training_output/1NN_2layer_leakyrelu_256_local_diffusivity_piecewise_linear_noclamp_VCABM3_reltol1e-5_lossequal_mae_glorot_ADAM1e-3"
...
NN = Chain(Dense(165, 512, leakyrelu), Dense(512, 512, leakyrelu), Dense(512, 124))
