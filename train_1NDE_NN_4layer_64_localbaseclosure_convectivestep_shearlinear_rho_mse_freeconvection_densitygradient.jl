...
FILE_DIR = "./training_output/NN_4layer_64_densitygradient_swish_local_diffusivity_convectivestep_shearlinear_glorot_freeconvection_mse_Adam1e-3"
mkpath(FILE_DIR)
@info "$(FILE_DIR)"
...
NN = Chain(Dense(35, 64, swish), Dense(64, 64, swish), Dense(64, 64, swish), Dense(64, 64, swish), Dense(64, 31))
...
# optimizers = [Optimizer(initial=OptimizationOptimisers.Adam(1e-3), initial_learning_rate=1e-3, learning_rate=1e-3, warmup=1, maxiter=20)]
