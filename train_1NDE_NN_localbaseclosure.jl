...
FILE_DIR = "./training_output/1NN_swish_256_local_diffusivity_NDE_gradient_relu_noclamp_VCABM3_GaussAdjoint_fast_test"
mkpath(FILE_DIR)
...
NN = Chain(Dense(165, 256, swish), Dense(256, 124))
