...
FILE_DIR = "./training_output/NN_swish_2layer_128_local_diffusivity_convectivestep_shearlinear_glorot_freeconvection_mme_Adam1e-3"
mkpath(FILE_DIR)
@info "$(FILE_DIR)"
...
NN = Chain(Dense(34, 128, swish), Dense(128, 128, swish), Dense(128, 31))
...
# optimizers = [Optimizer(initial=OptimizationOptimisers.Adam(1e-3), initial_learning_rate=1e-3, learning_rate=1e-3, warmup=40, maxiter=10)]
