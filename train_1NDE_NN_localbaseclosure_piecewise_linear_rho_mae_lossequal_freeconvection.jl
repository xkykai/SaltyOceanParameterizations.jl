...
FILE_DIR = "./training_output/NN_leakyrelu_local_diffusivity_piecewise_linear_rho_rho0.8_gradient_Adam_glorot_freeconvection_mae_ADAM5e-4"
mkpath(FILE_DIR)
@info "$(FILE_DIR)"
...
NN = Chain(Dense(34, 256, leakyrelu), Dense(256, 31))
...
# optimizers = [OptimizationOptimisers.ADAM(5e-4), OptimizationOptimisers.ADAM(5e-4)]
