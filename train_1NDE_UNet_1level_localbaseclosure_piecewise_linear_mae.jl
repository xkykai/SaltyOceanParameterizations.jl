...
FILE_DIR = "./training_output/UNet_1level_128_swish_local_diffusivity_piecewise_linear_noclamp_VCABM3_reltol1e-5_ADAM1e-3_glorotuniform_1e-6lastlayer_lossequal_mae"
mkpath(FILE_DIR)
@info "$(FILE_DIR)"
