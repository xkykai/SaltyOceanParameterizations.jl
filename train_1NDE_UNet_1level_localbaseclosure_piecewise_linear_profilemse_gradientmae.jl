...
FILE_DIR = "./training_output/UNet_1level_128_swish_local_diffusivity_piecewise_linear_noclamp_VCABM3_reltol1e-5_ADAM2e-5_lossequal_profilemse_gradientmae_test"
mkpath(FILE_DIR)
@info "$(FILE_DIR)"
