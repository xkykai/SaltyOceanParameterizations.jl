...
FILE_DIR = "./training_output/SW_FC_UNet_2level_1layer_256_swish_local_diffusivity_piecewise_linear_rho_lossequal_mae_Adam_noclamp_lossequal_mae_ADAM1e-4_test"
mkpath(FILE_DIR)
@info "$(FILE_DIR)"
