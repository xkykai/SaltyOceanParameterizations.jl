...
FILE_DIR = "./training_output/UNet_large_1level_512_swish_local_diffusivity_piecewise_linear_noclamp_VCABM3_reltol1e-5_ADAM1e-3_glorotuniform_lossequal_mae"
mkpath(FILE_DIR)
@info "$(FILE_DIR)"
...
layer4 = Chain(Dense(32*10, 512, swish),
               Dense(512, 124))
