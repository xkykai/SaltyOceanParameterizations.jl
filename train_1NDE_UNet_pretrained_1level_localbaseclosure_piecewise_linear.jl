...
NN_FILE_DIR = "./training_output/residual_flux_UNet_1level_128_swish_local_diffusivity_piecewise_linear_noclamp_ADAM1e-3_test/training_results_2.jld2"
...
NNs = jldopen(NN_FILE_DIR, "r")["NNs"]

ps_training.NDE.layer_8 .= 0
ps_training.NDE.layer_9 .= 0
