...
dirname = "NDE$(NN_grid_points)_FC_Qb_Ri_nof_BBLRifirst$(grid_point_below_kappa)$(grid_point_above_kappa)_$(LES_suite_name)_scaling$(scaling_LES_suite_name)_$(validation_LES_suite_name)_$(args["hidden_layer"])layer_$(args["hidden_layer_size"])_$(args["activation"])_$(seed)seed_2Pr_ls20_fulltime"
...
timeframes = [25:length(data["ubar"].times) for data in field_datasets]
...
function solve_NDE(ps, params, x₀, ps_baseclosure, sts, NNs, Nt, timestep_multiple=1)
    eos = TEOS10EquationOfState()
    coarse_size = params.coarse_size
