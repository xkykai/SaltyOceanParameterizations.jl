...
FILE_DIR = "./training_output/NDE_Qb_Rionly_absf_wTwS_$(length(LES_FILE_DIRS))simnew_$(args["hidden_layer"])layer_$(args["hidden_layer_size"])_$(args["activation"])_localbaseclosure_2Pr_nouvloss"
mkpath(FILE_DIR)
@info FILE_DIR
