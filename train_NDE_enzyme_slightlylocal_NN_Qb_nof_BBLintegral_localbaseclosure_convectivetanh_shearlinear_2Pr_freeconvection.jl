...
FILE_DIR = "./training_output/NDE_FC_dt5min_Qb_nof_BBLintegral_$(LES_suite_name)_scaling$(scaling_LES_suite_name)_$(args["hidden_layer"])layer_$(args["hidden_layer_size"])_$(args["activation"])_2Pr"
mkpath(FILE_DIR)
@info FILE_DIR
