...
FILE_DIR = "./training_output/nonlocalfullrun_slightlylocalNN_dTSrho/NDE_enzyme_$(args["hidden_layer"])layer_$(args["hidden_layer_size"])_$(args["activation"])_$(S_scaling)Sscaling_dTdSdrho_const"
mkpath(FILE_DIR)
@info FILE_DIR
