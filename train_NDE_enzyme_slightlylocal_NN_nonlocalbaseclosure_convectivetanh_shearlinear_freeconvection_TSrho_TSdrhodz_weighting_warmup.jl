...
FILE_DIR = "./training_output/nonlocalfullrun_slightlylocalNN/NDE_enzyme_$(args["hidden_layer"])layer_$(args["hidden_layer_size"])_$(args["activation"])_$(S_scaling)Sscaling_Adam3e-5"
mkpath(FILE_DIR)
@info FILE_DIR
...
function solve_NDE_postprocessing(ps, params, x₀, ps_baseclosure, sts, NNs, timestep, Nt, timestep_multiple=2)
    ...
    for i in 2:Nt_solve
        ...
        _, κs = predict_diffusivities(Ris, Ris_above, ∂ρ∂z, params.wρ.unscaled.top, ps_baseclosure)
