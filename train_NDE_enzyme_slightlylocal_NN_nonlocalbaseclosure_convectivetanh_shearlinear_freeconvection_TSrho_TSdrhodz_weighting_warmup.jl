...
FILE_DIR = "./training_output/nonlocalfullrun_slightlylocalNN/NDE_enzyme_$(args["hidden_layer"])layer_$(args["hidden_layer_size"])_$(args["activation"])_$(S_scaling)Sscaling_norho"
mkpath(FILE_DIR)
@info FILE_DIR
