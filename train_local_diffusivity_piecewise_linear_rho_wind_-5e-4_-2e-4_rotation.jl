...
FILE_DIR = "./training_output/local_diffusivity_piecewise_linear_rho_lossequal_wind_-5e-4_rotation"
mkpath(FILE_DIR)
...
optimizers = [OptimizationOptimisers.ADAM(5e-3),
              OptimizationOptimisers.ADAM(2e-3),
