...
ensemble_losses = [loss_multipleics(ComponentArray(ν_conv=ps_fixed.ν_conv, ν_shear=p[1], Riᶜ=p[2], Pr_conv=ps_fixed.Pr_conv, Pr_shear=p[3], ΔRi=ps_fixed.ΔRi), 
...
ensemble_mean_loss = loss_multipleics(ComponentArray(ν_conv=ps_fixed.ν_conv, ν_shear=ensemble_mean[1], Riᶜ=ensemble_mean[2], Pr_conv=ps_fixed.Pr_conv, Pr_shear=ensemble_mean[3], ΔRi=ps_fixed.ΔRi), 
