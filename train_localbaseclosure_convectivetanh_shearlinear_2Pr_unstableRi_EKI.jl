...
ensemble_losses = [loss_multipleics(ComponentArray(ν_conv=p[1], ν_shear=ps_fixed.ν_shear, Riᶜ=ps_fixed.Riᶜ, Pr_conv=p[2], Pr_shear=ps_fixed.Pr_shear, ΔRi=p[3]), 
...
ensemble_mean_loss = loss_multipleics(ComponentArray(ν_conv=ensemble_mean[1], ν_shear=ps_fixed.ν_shear, Riᶜ=ps_fixed.Riᶜ, Pr_conv=ensemble_mean[2], Pr_shear=ps_fixed.Pr_shear, ΔRi=ensemble_mean[3]), 
